...
*---------------------------------------------------------------------------
cd "[insert_own_filepath]" // insert own file path

global ukhls   "[insert_own_filepath]" // insert own file path
global outputpath "[insert_own_filepath]" // insert own file path
