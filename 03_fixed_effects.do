/*===========================================================================
  ...
  PURPOSE: Fixed effects models for caregiving transitions (entry and exit)
           and health behaviours. Covers:
             - Symmetric FE model (caregiving status)
             - Caregiving hours
             - Asymmetric entry and exit models
...
*--- Lag variable (for symmetric vs asymmetric comparison) ---
...
*   [SYM]    = symmetric model (caregiving status, no direction)
*   [ASYM]   = asymmetric model (entry and exit simultaneously)
...
*===========================================================================
* [ENTRY] SYMMETRIC AND CAREGIVING HOURS MODELS
*===========================================================================

*--- [SYM] Symmetric model: caregiving status ---
`cmd' `depvar' carebi i.wave, `opts'
...
*--- [ENTRY] Asymmetric: entry only ---
`cmd' `depvar' caregiving_intro i.wave, `opts'
`cmd' `depvar' caregiving_intro i.wave $covariates, `opts'
...
*===========================================================================
* [ASYM] SYMMETRIC VS ASYMMETRIC COMPARISON
*===========================================================================

*--- Symmetric ---
`cmd' `depvar' carebi i.wave, `opts'

*--- Asymmetric: entry and exit simultaneously ---
`cmd' `depvar' start_care stop_care i.wave, `opts'

*--- Asymmetric: entry only ---
`cmd' `depvar' start_care i.wave, `opts'

*--- Asymmetric: exit only ---
`cmd' `depvar' stop_care i.wave, `opts'

di as result "===== 03_fixed_effects.do completed for outcome: `outcome' ====="
